...
import { UserPreferences } from "@/pages";
...
const StartPlanning = () => {
  ...
  const renderSectionHeader = (icon, title) => (
    <div className="flex items-center space-x-3 mb-6">
      <div className="flex items-center justify-center w-12 h-12 rounded-full bg-travel-600 text-white">
        {icon}
      </div>
        ...
        <div className="max-w-6xl mx-auto mb-12">
          ...
          <div className="space-y-16">
            ...
            <section id="destinations-section" className={`bg-white rounded-xl p-6 shadow-sm border transition-opacity duration-500 ${showDestinations ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
              {renderSectionHeader(<MapPin size={24} />, "Choose Your Destinations")}
              {showDestinations && (
                // <Destinations 
